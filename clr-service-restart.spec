...
Source0  : https://github.com/clearlinux/clr-service-restart/releases/download/v2/clr-service-restart-2.tar.xz
...
%prep
%setup -q -n clr-service-restart-2
...
export LANG=C
export SOURCE_DATE_EPOCH=1516136776
