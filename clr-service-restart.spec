...
Version  : 5
Release  : 12
URL      : https://github.com/clearlinux/clr-service-restart/releases/download/v5/clr-service-restart-5.tar.xz
Source0  : https://github.com/clearlinux/clr-service-restart/releases/download/v5/clr-service-restart-5.tar.xz
...
%prep
%setup -q -n clr-service-restart-5
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1553722567
