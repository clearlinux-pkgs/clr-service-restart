...
Version  : 7
Release  : 15
URL      : https://github.com/clearlinux/clr-service-restart/releases/download/v7/clr-service-restart-7.tar.xz
Source0  : https://github.com/clearlinux/clr-service-restart/releases/download/v7/clr-service-restart-7.tar.xz
...
%prep
%setup -q -n clr-service-restart-7
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1558368182
